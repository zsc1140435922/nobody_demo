...
public class StreamDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             * BufferedReader reader = new BufferedReader(new FileReader("/Users/zhangshichuang/yunzong/insertSql.txt"));
             ...
             */
            /*List<String> list7 = Arrays.asList("a,b,c", "1,2,3");
            //将每个元素转成一个新的且不带逗号的元素
            Stream<String> s1 = list7.stream().map(s -> s.replaceAll(",", ""));
            s1.forEach(System.out::println); // abc  123

            Stream<String> s3 = list7.stream().flatMap(s -> {
                //将每个元素转换成一个stream
...
//            Student{name='bb', age=100}
            ...
            */
             ...
             *
             * T reduce(T identity, BinaryOperator<T> accumulator)：流程跟上面一样，只是第一次执行时，accumulator函数的第一个参数为identity，
             * 而第二个参数为流中的第一个元素。
